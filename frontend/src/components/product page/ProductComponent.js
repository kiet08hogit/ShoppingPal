            ...
            return (
              ...
              <div onClick={()=>{navigate(`/products/${elem.id}`)}} className="singleContainer">
                  ...
                  <div>
                      ...
                      <p style={{textDecoration: "line-through"}}><span style={{fontSize:"14px"}} >$</span>{Math.trunc(((elem.salesPrice.numeral) * 100 - 1)*1.1)}</p>
                      <h4 style={{fontWeight:"bolder",marginTop:"-10px"}}><span style={{fontSize:"14px"}} >$</span>{Math.trunc(elem.salesPrice.numeral) * 100 - 1}</h4>
